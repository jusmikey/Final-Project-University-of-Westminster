...
<?php 
  ...
  <?php
	...
	if($_SESSION['email'] == $fetch_dispute['guest_email']) {
	...
	if(empty($_POST['dispute_type']) || empty($_POST['dispute_reason'])) {
	  ...
	  //$to = $fetch_dispute['guest_email'];  Send email to user
	...
	if($update_dispute && $update_status_payment) {
	  ...
	  echo "<script>window.open('index.php?action=view_guest_dispute_information&invoice_id=$in_id&dispute_id=$dispute_id','_self') </script>";
...
<div class="view_product_box" >
  ...
  <div class="dispute_info_container">
	...
	<p><?php echo $fetch_dispute['guest_email']; ?></p>
	<br>
  ...
  <div class="resolvement_container">	    
	...
	<tr>
	  ...
	  <td colspan="3">
	    <textarea class="text_area_dispute_guest" rows="10" cols="50" name="dispute_reason" required></textarea>
	  </td>
	</tr><br>  
	...
	<?php } ?>
      ...
      <div class="border_bottom"></div>
 <a href="index.php?action=view_disputes_guest" style="float:right; width:100%; color:black; text-decoration:none; font-size:18px;"><i class="fa fa-arrow-left"></i>  Go back to guest disputes</a></td>

...
?>
  ...
  <p><b>Consumer Type: </b>Guest</p>
  <p><b>Guest Email: </b><?php echo $row['guest_email']; ?></p>
  <br>
  ...
  <div class="border_bottom"></div>
  <a class="go_back" href="index.php?action=view_guest_deliveries"><i class="fa fa-arrow-left"></i> Go back to all Guest Deliveries</a>

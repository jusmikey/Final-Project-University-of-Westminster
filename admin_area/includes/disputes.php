...
<div class="view_product_box" >
  ...
  <table>
    ...
    <?php 
	$purchase_result = mysqli_query($con, "select * from FYP_Disputes where consumer_type='user' order by dispute_timestamp desc ");
	...
	<tr>
	  ...
	  <td><a href="index.php?action=view_dispute_information&invoice_id=<?php echo $fetch_payment['invoice_id']; ?>&dispute_id=<?php echo $fetch_payment['dispute_id']; ?>">Dispute Case Information<a/></td>

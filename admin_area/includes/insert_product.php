	...
	<form action="" method="post" enctype="multipart/form-data">
	  <table align="center" width="100%"> 
		...
		<tr>
		  ...
		  <td><textarea id="add_content" name="product_desc" rows="7"></textarea>
		</tr>

		<tr>
		  <td valign="top"><b> Other Product Information: </b></td>
		  <td><textarea name="other_product_details" rows="7"></textarea></td>
		</tr>
		...
		<tr>
		  <td></td>
		  <td colspan="7"><input type="submit" name="insert_post" value="Add Product" style="padding:7px;width:300px;" /></td>
		</tr>
...
<?php 
  ...
  if(isset($_POST['insert_post'])) {
	...
	$insert_product = " insert into FYP_Products (product_title, product_category, product_brand, product_country, product_city, product_diet, product_image, product_price, product_desc, other_product_details, product_keywords) 
		values ('$product_title','$product_cat','$product_brand','$product_country','$product_city','$product_diet','$product_image','$product_price','$product_desc','$other_product_info','$product_keywords') ";
